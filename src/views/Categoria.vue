        ...
        <table class="w-full text-left border-collapse whitespace-nowrap">
          ...
          <tbody class="text-xs text-gray-700 divide-y divide-gray-100">
            ...
            <tr v-for="cat in categorias" :key="cat.id" class="hover:bg-gray-50 transition">
              <td class="py-4 px-5 font-bold text-[#0a3622] text-sm">{{ cat.nombre }}</td>
    ...
    >
      <div class="bg-white rounded-[24px] w-full max-w-sm shadow-2xl relative overflow-hidden">
        ...
        <div class="p-8 pt-10 text-center">
          <h2 class="text-xl font-extrabold text-[#0a3622] mb-1">Nueva Categoría</h2>
          <p class="text-[11px] text-gray-400 font-medium mb-6">Define el nombre de la categoría</p>
...
// Datos limpios de la tabla
const categorias = ref([
  { id: 1, nombre: 'Bebidas' },
  { id: 2, nombre: 'Golosinas' },
  { id: 3, nombre: 'Limpieza' },
  { id: 4, nombre: 'Aseo Personal' },
  { id: 5, nombre: 'Librería' },
