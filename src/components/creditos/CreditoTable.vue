        ...
        <tbody class="text-sm text-gray-700 divide-y divide-gray-100">
          <tr v-for="cliente in clientes" :key="cliente.id" class="hover:bg-gray-50 transition">
            <td class="py-4 px-5 flex items-center gap-3">
              ...
              <span class="font-bold text-gray-800">{{ cliente.nombre }}</span>
            </td>
            <td class="py-4 px-5 font-bold text-gray-800">{{ cliente.dui }}</td>
            ...
            <td class="py-4 px-5 text-center font-bold text-red-600">${{ cliente.totalDeuda }}</td>
            <td class="py-4 px-5 text-center font-bold text-green-700">${{ cliente.totalAbonado }}</td>
            <td class="py-4 px-5 text-center">
          ...
          <tr v-if="clientes.length === 0">
            <td colspan="7" class="py-10 text-center italic text-gray-400">No se encontraron resultados.</td>
          </tr>
        </tbody>
      </table>
    </div>
